...
if (!$conn){
  ...
  // Sql query to be executed 
   ...
   if ($num==1){
	  ...
	  // header("location:./subjects.php?subjects=urldecode($sec)");
   }
			...
			<div class="modal-body">
				<form action="subjects.php" method="post">
					<div class="form-group">
						...
						<input type="number" class="form-control" name="username" placeholder="Student Number" required="required">
					</div>
					<div class="form-group">
						SECTION :  
                            <select name="section" required>  
								...
								<option value="CS/IT1">CS/IT1</option>
								<option value="CSIT2">CS/IT2</option>
								<option value="CS/IT3">CSIT3</option>
